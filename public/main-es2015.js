...
/* harmony import */ var src_app_services_toast_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_services/toast.service */ "Eln7");
...
const apiUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}api/post/`;
...
const apiUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}api/category`;
...
let ToastService = class ToastService {
    ...
    // Error message
    showErrorToast(message, title = "", timeOut = 5000, extendedTimeOut = 5000, easeTime = 700) {
        this.removeToast();
    ...
    // Info message
    showInfoToast(message, title = "", timeOut = 5000, extendedTimeOut = 5000, easeTime = 700) {
        this.removeToast();
    ...
    // Success message
    showSuccessToast(message, title = "", timeOut = 5000, extendedTimeOut = 5000, easeTime = 700) {
        this.removeToast();
...
/* harmony import */ var _services_category_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../_services/category.service */ "AfT/");
/* harmony import */ var _services_home_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_services/home.service */ "x+LS");
/* harmony import */ var _services_toast_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_services/toast.service */ "Eln7");
...
let BlogComponent = class BlogComponent {
    constructor(route, authApi, catApi, api, toastService) {
        this.route = route;
        this.authApi = authApi;
        this.catApi = catApi;
        this.api = api;
    ...
    intercept(request, next) {
        if (request.url === 'https://sarkblog.herokuapp.com/api/auth/login' ||
            ...
            request = request.clone({
                headers: request.headers.append('Authorization', 'Basic ' + `${btoa('sarkblog:SarkblogUser')}`),
            });
        }
        else {
            request = request.clone({
            ...
            switch (error.status) {
                ...
                default:
                    if (error.error.message) {
                        ...
                        this.toast.showInfoToast("Connection lost, try again in a moment!.");
                    }
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(error);
                    break;
            }
