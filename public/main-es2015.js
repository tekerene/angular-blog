...
module.exports = __webpack_require__(/*! C:\Users\user\Desktop\projects\sarkblog\angular-blog\client\src\main.ts */"zUnb");
    ...
    intercept(request, next) {
        if (request.url === 'https://sarkblog.herokuapp.com/api/auth/login' ||
            ...
            request = request.clone({
                headers: request.headers.append('Authorization', 'Basic ' + `${btoa('ActivaApp:ActivaUser')}`),
            });
        }
        else {
            request = request.clone({
