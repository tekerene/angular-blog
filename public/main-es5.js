(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function ydo(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        ...
        _createClass(CategoryAddComponent, [{
          ...
          value: function ngOnInit() {
            this.categoryForm = this.formBuilder.group({
              catName: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              catDesc: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              catImgUrl: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              catContent: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required]
            });
          }
        }, {
          key: "onFormSubmit",
        ...
        _createClass(DetailsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.api.incrementPageCount().then(function (data) {
              return _this3.serviceCount.changeCount(data);
            });
          }
        }, {
          key: "getPostDetails",
          value: function getPostDetails(id) {
            ...
            this.api.getPost(id).subscribe(function (data) {
              ...
              _this4.pageId = "post/details/".concat(_this4.post.id);
          ...
          value: function getPostCategory(id) {
            ...
            this.cat.getCategory(id).subscribe(function (data) {
              //console.log(data)
              _this5.checkCat = data;
              console.log(_this5.checkCat);
        ...
        _createClass(BycategoryComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              _this10.getPostsByCategory(_this10.route.snapshot.params.id);
            });
          }
        }, {
    ...
    function H8dG(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ":root {\n  --input-padding-x: 1.5rem;\n  --input-padding-y: .75rem;\n}\n\nbody {\n  background: #007bff;\n  background: linear-gradient(to right, #0062E6, #33AEFF);\n}\n\n.card-signin {\n  border: 0;\n  border-radius: 1rem;\n  box-shadow: 0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1);\n  overflow: hidden;\n}\n\n.card-signin .card-title {\n  margin-bottom: 2rem;\n  font-weight: 300;\n  font-size: 1.5rem;\n}\n\n.card-signin .card-img-left {\n  width: 45%;\n  /* Link to your background image using in the property below! */\n  background: scroll center url(\"https://source.unsplash.com/WEQbe2jBg40/414x512\");\n  background-size: cover;\n}\n\n.card-signin .card-body {\n  padding: 2rem;\n}\n\n.form-signin {\n  width: 100%;\n}\n\n.form-signin .btn {\n  font-size: 80%;\n  border-radius: 5rem;\n  letter-spacing: 0.1rem;\n  font-weight: bold;\n  padding: 1rem;\n  transition: all 0.2s;\n}\n\n.form-label-group {\n  position: relative;\n  margin-bottom: 1rem;\n}\n\n.form-label-group input {\n  height: auto;\n  border-radius: 2rem;\n}\n\n.form-label-group > input,\n.form-label-group > label {\n  padding: var(--input-padding-y) var(--input-padding-x);\n}\n\n.form-label-group > label {\n  position: absolute;\n  top: 0;\n  left: 0;\n  display: block;\n  width: 100%;\n  margin-bottom: 0;\n  /* Override default `<label>` margin */\n  line-height: 1.5;\n  color: #495057;\n  border: 1px solid transparent;\n  border-radius: 0.25rem;\n  transition: all 0.1s ease-in-out;\n}\n\n.form-label-group input::-moz-placeholder {\n  color: transparent;\n}\n\n.form-label-group input::placeholder {\n  color: transparent;\n}\n\n.form-label-group input:not(:-moz-placeholder-shown) {\n  padding-top: calc(var(--input-padding-y) + var(--input-padding-y) * (2 / 3));\n  padding-bottom: calc(var(--input-padding-y) / 3);\n}\n\n.form-label-group input:not(:placeholder-shown) {\n  padding-top: calc(var(--input-padding-y) + var(--input-padding-y) * (2 / 3));\n  padding-bottom: calc(var(--input-padding-y) / 3);\n}\n\n.form-label-group input:not(:-moz-placeholder-shown) ~ label {\n  padding-top: calc(var(--input-padding-y) / 3);\n  padding-bottom: calc(var(--input-padding-y) / 3);\n  font-size: 12px;\n  color: #777;\n}\n\n.form-label-group input:not(:placeholder-shown) ~ label {\n  padding-top: calc(var(--input-padding-y) / 3);\n  padding-bottom: calc(var(--input-padding-y) / 3);\n  font-size: 12px;\n  color: #777;\n}\n\n.btn-google {\n  color: white;\n  background-color: #ea4335;\n}\n\n.btn-facebook {\n  color: white;\n  background-color: #3b5998;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
      ...
      var BlogComponent = /*#__PURE__*/function () {
        ...
        _createClass(BlogComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.api.getPosts().subscribe(function (res) {
              _this12.posts = res; // this.data = res.results;
          ...
          */
          ...
          value: function filterPost() {
            ...
            this.api.getPosts().subscribe(function (res) {
              _this13.posts = res.map(function (o) {
          ...
          value: function getuser(id) {
            ...
            this.authApi.getUser(id).subscribe(function (res) {
              _this16.singleUser = res;
              console.log(_this16.singleUser);
        ...
        _createClass(HomeService, [{
          ...
          value: function incrementPageCount() {
            ...
            var pageCount = this.af.object('/pageCount/').$ref.ref.transaction(function (count) {
              _this17.counter = count;
              return _this17.counter + 1;
            }).then(function (data) {
          ...
          value: function getPosts() {
            ...
            return this.http.get(apiUrl + 'post').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              return _this19.log('fetched Posts');
          ...
          value: function getPostsByCategory(id) {
            ...
            return this.http.get(apiUrl + 'bycategory/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              return _this20.log('fetched Posts');
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getPosts', [])));
          }
        }, {
          key: "getPost",
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.authService.isLoggedIn.subscribe(function (status) {
              ...
              if (status === true) {
                _this22.loginStatus = true;
              } else {
                _this22.loginStatus = false;
              }
            });
            this.api.getCategories().subscribe(function (res) {
              _this22.categories = res;
        ...
        _createClass(CategoryDetailsComponent, [{
          ...
          value: function getCategoryDetails(id) {
            ...
            this.api.getCategory(id).subscribe(function (data) {
              _this24.category = data;
              _this24.category.id = data._id;
              console.log(_this24.category);
          ...
          value: function deleteCategory(id) {
            ...
            this.api.deleteCategory(id).subscribe(function (res) {
              ...
              _this25.router.navigate(['/category']);
            }, function (err) {
              console.log(err);
              _this25.isLoadingResults = false;
            });
        ...
        _createClass(AuthService, [{
          ...
          value: function getUsers() {
            ...
            return this.http.get(apiUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              return _this28.log('fetched Users');
          ...
          value: function login(data) {
            ...
            return this.http.post(apiUrl + 'login', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              _this29.isLoggedIn.emit(true);

              _this29.loggedInStatus = true;
          ...
          value: function logout() {
            ...
            return this.http.post(apiUrl + 'logout', {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              _this30.isLoggedIn.emit(false);

              _this30.loggedInStatus = false;
    ...
    /***/
    function fhD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(CategoryEditComponent, [{
          ...
          value: function onFormSubmit() {
            ...
            this.api.updateCategory(this.id, this.categoryForm.value).subscribe(function (res) {
              ...
              _this38.router.navigate(['/category/details', id]);
            }, function (err) {
              console.log(err);
              _this38.isLoadingResults = false;
            });
    ...
    /***/
    function hkG8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PostDetailsComponent = /*#__PURE__*/function () {
        ...
        _createClass(PostDetailsComponent, [{
          ...
          value: function getPostDetails(id) {
            ...
            this.api.getPost(id).subscribe(function (data) {
              _this40.post = data;
              _this40.post.id = data._id;
              console.log(_this40.post);
      ...
      var CategoryService = /*#__PURE__*/function () {
        ...
        _createClass(CategoryService, [{
          ...
          value: function getCategories() {
            ...
            return this.http.get(apiUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) {
              return _this42.log('fetched Categories');
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategories', [])));
          }
        }, {
          key: "getCategory",
          ...
          value: function handleError() {
            ...
            return function (error) {
              ...
              _this43.log("".concat(operation, " failed: ").concat(error.message));
    ...
    function uj5D(module, __webpack_exports__, __webpack_require__) {
      ...
      var _category_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../category.service */
      "rx/G");
      /** Error when invalid control is dirty, touched, or submitted. */
        ...
        _createClass(PostAddComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.postForm = this.formBuilder.group({
              ...
              postTitle: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              postAuthor: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              postDesc: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              postContent: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              postReference: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              postImgUrl: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
              readTime: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required]
            });
          }
        }, {
          key: "onFormSubmit",
          value: function onFormSubmit() {
            ...
            this.api.addPost(this.postForm.value).subscribe(function (res) {
              ...
              _this44.router.navigate(['/post/details', id]);
            }, function (err) {
              console.log(err);
              _this44.isLoadingResults = false;
            });
      ...
      var PostEditComponent = /*#__PURE__*/function () {
        ...
        _createClass(PostEditComponent, [{
          ...
          value: function getCategories() {
            ...
            this.catApi.getCategories().subscribe(function (res) {
              _this47.categories = res;
              console.log(_this47.categories);
          ...
          value: function onFormSubmit() {
            ...
            this.api.updatePost(this.id, this.postForm.value).subscribe(function (res) {
              ...
              _this48.router.navigate(['/post/details', id]);
            }, function (err) {
              console.log(err);
              _this48.isLoadingResults = false;
            });
